            ...
            <div className="mt-10 container">
              <div className="flex flex-col items-center justify-center ">
                ...
                <ul className="max-w-md  px-6 mx-auto lg:max-w-xl lg:px-0 list-disc text-darkgray mb-10 poppins">
                  ...
                  <li>
                    Internship protection unit maintenance at PT. Indonesian
                    Power
                  </li>
                  <li>
                  ...
                  <li>
                    Member of the PDD Bubertro division (Buka Bersama Elektro)
                    HME STT-PLN in 2019
                  </li>
                  <li>
                    Active Member of Research and Technopreneurship 2019 -
                    Present
                  </li>
                  <li>
                    Members of the PDD division for the introduction and
                    training of the early stages of electrical students (PLTAME)
                    in 2019
                  </li>
                  <li>
                  ...
                  <li>
                    PDD division member Pre-TD student management skills
                    training 2019
                  </li>
