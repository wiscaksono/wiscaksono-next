        ...
        <div className="mt-10 container">
          <div className="flex flex-col items-center justify-center ">
            ...
            <p className="leading-relaxed text-center align-center text-darkgray w-[576px]">
              ...
              sociable person, able to work well together, and able to implement
              the material that I understand. Besides, I can operate various
            ...
            <ul className="max-w-md  px-6 mx-auto lg:max-w-xl lg:px-0 list-disc text-darkgray mb-10">
              ...
              <li>
                Head of the PDD Division 2021 student leadership basic training
              </li>
              <li>ITPLN control system laboratory assistant. 2020 - Present</li>
              <li>Charger 2020 magazine initiator & editor</li>
              <li>Basic Training of HME STT-PLN Student Leadership in 2019</li>
              <li>
              ...
              <li>
                Members of the PDD division for the introduction and training of
                the early stages of electrical students (PLTAME) in 2019
              </li>
              <li>
              ...
              <li>Electrical unit maintenance at PT. Krakatau Wajatama 2017</li>
            </ul>
          </div>
        </div>
      </div>
